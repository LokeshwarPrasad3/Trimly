...
const highlights = [
  "Claim guest links automatically after sign in.",
  "Open the full dashboard and manage links in one place.",
  "Keep using the logged-in workspace for free in v1.",
];
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            <h1 className="max-w-2xl text-5xl font-semibold tracking-tight text-slate-950 sm:text-6xl">
              Return to your link workspace with a cleaner, faster flow.
            </h1>
            <p className="max-w-xl text-base leading-7 text-slate-600">
              Sign in to access link management, analytics, and all guest links already created on this device.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.75rem] border border-white/70 bg-white/75 p-5 shadow-[0_24px_60px_-45px_rgba(15,23,42,0.3)] backdrop-blur">
              <div className="flex items-center gap-3 text-slate-950">
                ...
                <p className="font-semibold">Fast auth flow</p>
              </div>
              <p className="mt-3 text-sm leading-6 text-slate-600">Cookie-based sessions and redirect into the protected dashboard.</p>
            </div>
            <div className="rounded-[1.75rem] border border-white/70 bg-[linear-gradient(135deg,_rgba(14,165,233,0.14),_rgba(255,255,255,0.92),_rgba(34,211,238,0.14))] p-5 shadow-[0_24px_60px_-45px_rgba(15,23,42,0.3)] backdrop-blur">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-sky-700">Connected</p>
              <p className="mt-3 text-3xl font-semibold tracking-tight text-slate-950">Live API</p>
              <p className="mt-2 text-sm leading-6 text-slate-600">This form is already wired to the current backend auth routes.</p>
            </div>
          </div>
          <div className="space-y-3 rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-[0_24px_60px_-45px_rgba(15,23,42,0.3)] backdrop-blur">
            ...
            <Link href="/guest-links" className="inline-flex items-center gap-2 pt-2 text-sm font-medium text-sky-700 hover:underline">
