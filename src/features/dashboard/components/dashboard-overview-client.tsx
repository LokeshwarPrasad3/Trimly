        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-3 max-w-3xl text-2xl font-semibold tracking-tight text-slate-950">
              Your links, clicks, and recent activity in one clean workspace.
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              The dashboard now reads from live authenticated APIs, so the
              overview reflects the signed-in user instead of mocked data.
            </p>
          </div>
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Latest authenticated links from your workspace
              </p>
            </div>
            <Link
