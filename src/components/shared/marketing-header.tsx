    ...
    <header className="sticky top-0 z-30 border-b border-white/60 bg-white/72 backdrop-blur-2xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          <Link href="/sign-in" className={linkButtonClass("ghost", "hidden rounded-xl px-4 py-2 text-slate-600 hover:bg-white/70 hover:text-slate-950 sm:inline-flex")}>
            Sign in
          </Link>
          <Link href="/guest-links" className={linkButtonClass("primary", "rounded-xl px-4 py-2 shadow-[0_18px_35px_-22px_rgba(14,165,233,0.85)]")}>
            Start free
          </Link>
        </div>
      </div>
